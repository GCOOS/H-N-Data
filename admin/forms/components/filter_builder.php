...
class FilterCondition {
    ...
    private final function GetOperatorAsString(Captions $captions) {
        switch ($this->GetOperator()) {
            case FilterConditionOperator::Equals:
                return $captions->GetMessageString('FilterOperatorEquals');
                break;
            case FilterConditionOperator::DoesNotEqual:
                return $captions->GetMessageString('FilterOperatorDoesNotEqual');
                break;
            case FilterConditionOperator::IsGreaterThan:
                return $captions->GetMessageString('FilterOperatorIsGreaterThan');
                break;
            case FilterConditionOperator::IsGreaterThanOrEqualTo:
                return $captions->GetMessageString('FilterOperatorIsGreaterThanOrEqualTo');
                break;
            case FilterConditionOperator::IsLessThan:
                return $captions->GetMessageString('FilterOperatorIsLessThan');
                break;
            case FilterConditionOperator::IsLessThanOrEqualTo:
                return $captions->GetMessageString('FilterOperatorIsLessThanOrEqualTo');
                break;
            case FilterConditionOperator::IsBetween:
...
class FilterBuilderControl {
    ...
    public function __construct(Grid $grid, Captions $captions) {
        ...
        $this->generator = new GenericFilterSQLGenerator(
            ...
            //new EngCommandImp(new MyConnectionFactory())
        );
        $this->fields = array();
    }
    ...
    public final function Accept(Renderer $renderer)
    {
        //$renderer->RenderFilterBuilderControl($this);
    }
