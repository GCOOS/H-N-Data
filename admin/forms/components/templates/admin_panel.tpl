...
<head>
    ...
    <script>{literal}
    var require = { baseUrl: "components/js" };
    {/literal}
    </script>
...
<div id="pg-admin-create-user-dialog" class="modal hide">
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newuser-username">Name</label>
                <div class="controls">
                    <input type="text" id="newuser-username" name="id" data-bind="value: newUser.name" />
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="newuser-password">Password</label>
                <div class="controls">
                    <input type="password" id="newuser-password" name="id" data-bind="value: newUser.password" />
                </div>
            </div>
    ...
    <div class="modal-footer">
        <a href="#" class="btn" data-dismiss="modal" id="close-create-user-dialog">Close</a>
        <a href="#" class="btn btn-primary" id="save-create-user-dialog">Create user</a>
    </div>

</div>

<div id="pg-admin-change-user-password-dialog" class="modal hide">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><i class="icon-remove"></i></button>
        <h3>Change password for user '<span data-bind="text: changePasswordUser.name"></span>'</h3>
    </div>
    ...
    <div class="modal-body">
        ...
        <form class="form-horizontal">
            <fieldset>
            <div class="control-group">
                <label class="control-label" for="chpass-user-password">New password</label>
                <div class="controls">
                    <input id="chpass-user-password"
                           type="password"
                           name="password"
                           data-bind="value: changePasswordUser.password" />
                </div>
            </fieldset>
        </form>
    </div>
    ...
    <div class="modal-footer">
        <a href="#" class="btn" data-dismiss="modal" id="close-change-password-dialog">Close</a>
        <a href="#" class="btn btn-primary" id="save-change-password-dialog">Change password</a>
    </div>
</div>
...
<div id="pg-admin-edit-user-dialog" class="modal hide">
    ...
    <div class="modal-footer">
        <a href="#" class="btn" data-dismiss="modal" id="close-edit-user-dialog">Close</a>
        <a href="#" class="btn btn-primary" id="save-edit-user-dialog">Save changes</a>
    </div>
</div>
